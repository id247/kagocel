			...
			<div className="start start--adults">
				...
				<div className="start__bubble bubble">
					...
					<div className="start__text text">
						...
						<p>
							Здравствуйте! Я <strong>Доктор {PromoOptions.doctorName}</strong>. Я исследую работу органов человеческого тела и изучаю, как влияют на них простудные заболевания, вирусы и грипп. Когда мы болеем, практически каждый орган подвергается негативному воздействию. Если не лечить простуду должным образом, заболевание может распространиться по всему нашему телу.
						</p>
						<p>
